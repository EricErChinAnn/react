...
export default class TaskList extends React.Component {
    ...
    processEditTask = () => {
        ...
        // const left = this.state.tasks.slice(0, indexToReplace);
        // const right = this.state.tasks.slice(indexToReplace+1);
        const modified = [...this.state.tasks.slice(0, indexToReplace), clonedTask, ...this.state.tasks.slice(indexToReplace+1)];
                    ...
                    if (this.state.taskBeingEdited && 
                        ...
                        return (
                            <li key={eachTask.id}>
                                ...
                                <button onClick={this.beginCancelEditTask}>Cancel</button>
                            </li>
                        )
